...
namespace Azure.Core.TestFramework.Server
{
    ...
    {
        // Active recording sessions. Key is unique GUID.
        ...
        // !! TODO: sanitization cannot be customized yet.
        private static readonly RecordedTestSanitizer s_sanitizer = new RecordedTestSanitizer();

        // Headers which should be excluded from upstream requests
        ...
        // Client for upstream requests.
        private static readonly HttpClient s_client = new HttpClient();

        // POST /record/start: Starts a new recording session.
        //
        // Input:
        // - x-recording-file header: path to where to save recording on local disk.
        //
        // Output:
        ...
        // POST /record/stop: Ends a recording session.
        //
        // Input:
        // - x-recording-id header: The session ID returned by prior /record/start.
        // - x-reording-save header: "True" or "False - whether to persist the recording
        //
        // Output:
        // - None
        [HttpPost]
        ...
        // Forwards a request upstream, records and the response.
        //
        // Note that the request can be anything: the method, path, body, and headers
        // are to be sent upstream as is.
        //
        // Additional Input:
        // - x-recording-id header identifies the session
        ...
        private static HttpRequestMessage CreateUpstreamRequest(HttpRequest incomingRequest, byte[] incomingBody)
        {
